...
public class LoadMoreGridViewFragment extends DemoTitleBaseFragment {
	...
	public View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		headerMarginView.setLayoutParams(
				new AbsListView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, LocalDisplay.dp2px(20)));
		mGridView.addHeaderView(headerMarginView);

		// load more container
		final LoadMoreGridViewContainer loadMoreContainer = (LoadMoreGridViewContainer) view
		...
		EventCenter.bindContainerAndHandler(this, new DemoSimpleEventHandler() {
			...
			public void onEvent(ImageListDataEvent event) {
				...
				// load more complete
				loadMoreContainer.loadMoreFinish(mDataModel.getListPageInfo().isEmpty(),
