...
public class ImageListDataModel extends PagedListDataModel<ImageListItem> {
	...
	protected void doQueryData() {
		...
		DemoCacheRequest<ImageListDataEvent> request = new DemoCacheRequest<ImageListDataEvent>(
				new CacheAbleRequestDefaultHandler<ImageListDataEvent>() {
					...
					@Override
					public void onCacheAbleRequestFinish(ImageListDataEvent data, CacheAbleRequest.ResultType type,
							boolean outOfDate) {
